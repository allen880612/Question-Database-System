...
class AddUnitPage_UI(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_3.addWidget(self.button_add_level)
        ...
        self.horizontalLayout_3.addWidget(self.button_delete_level)
        ...
        self.gridLayout_2.addWidget(self.textBox_lv1, 2, 0, 1, 1)
        self.textBox_lv2 = QtWidgets.QLineEdit(self.centralwidget)
        self.textBox_lv2.setObjectName("textBox_lv2")
        self.gridLayout_2.addWidget(self.textBox_lv2, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_lv1, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_lv2, 1, 1, 1, 1)
