...
class ReviseMakeQuestion_UI(object):
    def setupUi(self, MainWindow):
        ...
        self.listView_make_question_level = QtWidgets.QListView(self.centralwidget)
        self.listView_make_question_level.setObjectName("listView_make_question_level")
        self.horizontalLayout_6.addWidget(self.listView_make_question_level)
